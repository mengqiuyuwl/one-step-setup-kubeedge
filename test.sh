...
kubeadm init --image-repository="registry.aliyuncs.com/google_containers" --kubernetes-version="v1.16.3" --node-name="192.168.56.159" --pod-network-cidr="200.1.0.0/16" --service-cidr="200.2.0.0/16"
mkdir /root/.kube/
